...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    /**
     * Asigna a variables los valores de los campos del form enviado por POST
     */
    $name = $_POST['fullname'];
    $email = $_POST['email'];
    $age = $_POST['age'];
...
<body class="w3-margin">
    <div class="w3-container w3-center">
        ...
        <form class="w3-container w3-center form-container" action="insert.php" method="post">
            <table class="w3-table w3-border w3-round w3-margin table-edit">
                <tbody>
                    ...
                    <tr>
                        <td colspan="2">
                            <input class="w3-btn w3-green w3-round w3-block" type="submit" value="Agregar">
                        </td>
                    </tr>
                </tbody>
            </table>
